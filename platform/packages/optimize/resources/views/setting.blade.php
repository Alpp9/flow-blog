...
>
    ...
    <div id="pagespeed-optimize-settings" @class(['mb-4 border rounded-top rounded-bottom p-3 bg-light', 'd-none' => ! setting('optimize_page_speed_enable')])>
        <x-core-setting::checkbox
            ...
            :value="setting('optimize_collapse_white_space', false)"
        ...
        <x-core-setting::checkbox
            ...
            :value="setting('optimize_elide_attributes', false)"
        ...
        <x-core-setting::checkbox
            ...
            :value="setting('optimize_inline_css', false)"
        ...
        <x-core-setting::checkbox
            ...
            :value="setting('optimize_insert_dns_prefetch', false)"
        ...
        <x-core-setting::checkbox
            ...
            :value="setting('optimize_remove_comments', false)"
        ...
        <x-core-setting::checkbox
            ...
            :value="setting('optimize_remove_quotes', false)"
        ...
        <x-core-setting::checkbox
            ...
            :value="setting('optimize_defer_javascript', false)"
